...
class ApiClient extends GetxService {
  ...
  static Future<Response> getData(String uri, {Map<String, String>? headers}) async {
    bearerToken = await PrefsHelper.instance.getString(AppConstants.instance.accessToken);
  ...
  static Future<Response> postData(String uri, dynamic body, {Map<String, String>? headers}) async {
    String bearerToken = await PrefsHelper.instance.getString(AppConstants.instance.accessToken);
